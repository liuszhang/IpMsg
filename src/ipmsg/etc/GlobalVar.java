...
public class GlobalVar {
    ...
    public static void initDefault(){
        ...
        try {
            if(OS==GlobalConstant.WINDOWS)
                HOST_NAME = USER_NAME;
            else HOST_NAME = InetAddress.getLocalHost().getHostName();
    ...
    public static boolean containWindow(String id){
        boolean res;
        MSG_WINDOW_REG_Lock.lock();
        if(MSG_WINDOW_REG.containsKey(id))res=true;
        else res=false;
        MSG_WINDOW_REG_Lock.unlock();
        return res;
    }
    public static MsgWindow getWindow(String id){
        MsgWindow res;
        MSG_WINDOW_REG_Lock.lock();
        if(!MSG_WINDOW_REG.containsKey(id))res=null;
        else res=MSG_WINDOW_REG.get(id);
        MSG_WINDOW_REG_Lock.unlock();
        return res;
    }
    //************************************************************************
